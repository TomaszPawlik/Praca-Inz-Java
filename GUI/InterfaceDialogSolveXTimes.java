...
public class InterfaceDialogSolveXTimes extends JDialog implements ItemListener{

	
	public JTextField numberOfSimulatios, numberOfPedestrians;
	...
	public int numberOfSimulations, numberOfNewPedestrians;
	public boolean randomStrategy = true;
	pedestrianStrategy newStrategy = pedestrianStrategy.ANT;
		
	InterfaceDialogSolveXTimes(Interface parent){
		super(parent, "Solve X Times", true);
	    Container contentPane = getContentPane();
	    JPanel p1 = new JPanel(new GridLayout(3, 2,3,3));
	    
	    numberOfSimulatios = new JTextField("0");
	    numberOfPedestrians = new JTextField("0");
	    randomStrategiesCheckBox = new JCheckBox("Yes");
	    randomStrategiesCheckBox.setSelected(true);
	    
	    p1.add(new JLabel("Number of simulations: "));
	    p1.add(numberOfSimulatios);
	    p1.add(new JLabel("Number of random pedestrians: "));
	    p1.add(numberOfPedestrians);
	...
	public void okButtonactionPerformed(ActionEvent e){
		okPressed = true;
		numberOfNewPedestrians = Integer.parseInt(numberOfPedestrians.getText());
		numberOfSimulations = Integer.parseInt(numberOfSimulatios.getText());
		setVisible(false);
	}
